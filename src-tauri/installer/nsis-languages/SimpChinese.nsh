...
LangString alreadyInstalledLong ${LANG_SIMPCHINESE} "${PRODUCTNAME} ${VERSION} 已安装。$\n请选择要执行的操作，然后点击下一步继续。"
...
LangString dontUninstallDowngrade ${LANG_SIMPCHINESE} "不卸载（此安装程序不允许不卸载直接降级）"
LangString failedToKillApp ${LANG_SIMPCHINESE} "无法结束 {{product_name}}。$\n请先关闭后再重试。"
LangString installingWebview2 ${LANG_SIMPCHINESE} "正在安装 WebView2..."
LangString newerVersionInstalled ${LANG_SIMPCHINESE} "已安装更新版本的 ${PRODUCTNAME}！不建议安装旧版本。如果确实要安装此旧版本，建议先卸载当前版本。$\n请选择要执行的操作，然后点击下一步继续。"
LangString older ${LANG_SIMPCHINESE} "较旧"
LangString olderOrUnknownVersionInstalled ${LANG_SIMPCHINESE} "系统中已安装 $R4 版本的 ${PRODUCTNAME}。建议先卸载当前版本后再安装。$\n请选择要执行的操作，然后点击下一步继续。"
LangString silentDowngrades ${LANG_SIMPCHINESE} "此安装程序不允许降级，无法继续静默安装，请改用图形界面安装程序。$\n"
...
LangString webview2AbortError ${LANG_SIMPCHINESE} "无法安装 WebView2！应用没有它无法运行。$\n请尝试重新启动安装程序。"
